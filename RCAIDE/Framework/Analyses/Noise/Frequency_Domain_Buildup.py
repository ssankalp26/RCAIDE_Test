            ...
            for propulsor in network.propulsors:
                for sub_tag , sub_item in  propulsor.items():
                    if isinstance(sub_item, RCAIDE.Library.Components.Propulsors.Converters.Rotor): 
                        rotor_tag         = compute_rotor_noise(microphone_locations,propulsor,sub_item,segment,settings, rotor_index = i, previous_rotor_tag= rotor_tag, compute_rotor_noise=network.identical_propulsors)   
