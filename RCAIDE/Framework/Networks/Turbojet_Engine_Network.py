...
class Turbojet_Engine_Network(Network):
    ...
    def evaluate_thrust(self,state,center_of_gravity = [[0,0,0]]):
        ...
        for fuel_line in fuel_lines:
            if fuel_line.active:   
                ...
                fuel_line_T,fuel_line_P = compute_turbojet_performance(fuel_line,state, center_of_gravity)  
    ...
    def unpack_unknowns(self,segment):
        ...
        fuel_lines = segment.analyses.energy.vehicle.networks.turbojet_engine.fuel_lines
    ...
    def add_unknowns_and_residuals_to_segment(self, segment ):
        ...
        for fuel_line_i, fuel_line in enumerate(fuel_lines):    
            ...
            # ------------------------------------------------------------------------------------------------------
            for turbojet in fuel_line.propulsors:               
                fuel_line_results[turbojet.tag]                         = RCAIDE.Framework.Mission.Common.Conditions() 
                ...
                noise_results[turbojet.tag]                             = RCAIDE.Framework.Mission.Common.Conditions() 
                noise_results[turbojet.tag].turbojet                    = RCAIDE.Framework.Mission.Common.Conditions() 
