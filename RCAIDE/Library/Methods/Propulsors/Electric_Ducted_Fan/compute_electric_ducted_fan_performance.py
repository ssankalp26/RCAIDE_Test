...
def compute_electric_ducted_fan_performance(propulsor,state,bus,voltage,center_of_gravity= [[0.0, 0.0,0.0]]):   
    ...
    ducted_fan_conditions      = conditions.energy[bus.tag][propulsor.tag] 
    ...
    compute_ducted_fan_performance(propulsor,state,bus,center_of_gravity)  
    ...
    ducted_fan_conditions.thrust      = conditions.energy[bus.tag][propulsor.tag][ducted_fan.tag].thrust 
    ducted_fan_conditions.moment      = conditions.energy[bus.tag][propulsor.tag][ducted_fan.tag].moment 
    
    T  = conditions.energy[bus.tag][propulsor.tag][ducted_fan.tag].thrust 
    M  = conditions.energy[bus.tag][propulsor.tag][ducted_fan.tag].moment 
    P  = conditions.energy[bus.tag][propulsor.tag][esc.tag].power 
    
    return T,M,P, stored_results_flag,stored_propulsor_tag 
                
def reuse_stored_electric_ducted_fan_data(propulsor,state,bus,stored_propulsor_tag,center_of_gravity= [[0.0, 0.0,0.0]]):
    ...
    ducted_fan_0               = bus.propulsors[stored_propulsor_tag].ducted_fan 
    ...
    conditions.energy[bus.tag][propulsor.tag][ducted_fan.tag]   = deepcopy(conditions.energy[bus.tag][stored_propulsor_tag][ducted_fan_0.tag])
    conditions.energy[bus.tag][propulsor.tag][esc.tag]          = deepcopy(conditions.energy[bus.tag][stored_propulsor_tag][esc_0.tag])
  
    thrust                  = conditions.energy[bus.tag][propulsor.tag][ducted_fan.tag].thrust 
    ...
    conditions.energy[bus.tag][propulsor.tag][ducted_fan.tag].moment = moment  
