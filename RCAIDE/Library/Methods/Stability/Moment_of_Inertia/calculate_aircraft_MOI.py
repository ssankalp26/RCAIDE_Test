...
def calculate_aircraft_MOI(vehicle, CG_location): 
    ...
    total_MOI = np.zeros((3, 3)) # Array to hold the entire aircraft's inertia tensor
            ...
            for propulsor in fuel_line.propulsors: 
                ...
                for fuel_tank in fuel_line.fuel_tanks:
                    ...
                    if isinstance(fuel_tank,RCAIDE.Library.Components.Energy.Sources.Fuel_Tanks.Wing_Fuel_Tank): 
                        I_network += compute_wing_moment_of_inertia(vehicle.wings["main_wing"], fuel_tank.mass_properties.mass, CG_location, fuel_flag=True)
                    else:
                        pass # TO DO 
